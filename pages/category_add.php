...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $mysqli->prepare("SELECT id FROM categories WHERE slug = ?");
    ...
    <form method="POST" class="form">
        ...
        <div class="form-group">
            ...
            <input type="text" id="slug" name="slug" value="<?= htmlspecialchars($slug) ?>"
                   pattern="[a-z0-9\-]+">
            <small>Lowercase letters, numbers, and hyphens only (auto-generated from name). Leave empty to auto‑generate.</small>
        </div>
