...
### Adding New Features
1. **New pages**: Follow the file include pattern in `CLAUDE.md`
2. **New permissions**: Add via Admin Panel → Manage Permissions
3. **Database changes**: Create migration SQL file
4. **Security**: Always use prepared statements and CSRF tokens

### Code Standards
- **Strict typing**: `declare(strict_types=1)` in all PHP files
- **Security first**: Never trust user input
- **Consistent patterns**: Follow existing architecture
